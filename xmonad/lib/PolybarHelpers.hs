...
rightMon    = intercalate ", " $ replicate 10 "1920, 0"
leftMon     = intercalate ", " $ replicate 10 "0, 0"      
viewportStr = intercalate ", " [leftMon,rightMon]

{-comment starts here (note: 9 and 10 here after replicate denotes total workspaces)
--------------------------original setup with 3 minitors-------------------------
