...
--polybar0 = statusBarPropTo "_XMONAD_LOG_3" "polybar --config=~/.config/polybar/config.ini" (myXmobarPP) --polybar method 2
...
--barSpawner 0 = pure polybar0 --if you want to use polybar, uncomment this and comment out 'barSpawner 0 = pure (xmobar0)' --polybar method 2
