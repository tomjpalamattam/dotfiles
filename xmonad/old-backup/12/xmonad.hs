...
myKeys =
--    [("M-" ++ m ++ k, windows $ f i) --without independent screens
    [("M-" ++ m ++ k, windows $ onCurrentScreen f i) --with independent screens --used with XMonad.Layout.IndependentScreens 
        | (i, k) <- zip (myWorkspaces) (map show [1 :: Int ..])
     --   | (i, k) <- zip (myWorkspaces) (map show [1 .. 9 :: Int])  
...
{-  --comment starts here. This is not compatable with indipendedt screens module
