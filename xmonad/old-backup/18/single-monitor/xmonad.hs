...
myXmobarPP0 :: X PP
--myXmobarPP = clickablePP . filterOutWsPP [scratchpadWorkspaceTag] $ def
myXmobarPP0 = clickablePP.marshallPP (S 0) $ def
    { ppSep             = "<fc=#586E75> | </fc>" 
    , ppTitleSanitize   = xmobarStrip
    , ppCurrent         = xmobarColor "#ffffff" "#5e8d87" . pad
    , ppHidden          = xmobarColor "#82AAFF" "" . wrap "*" ""
...
myXmobarPP1 :: X PP
--myXmobarPP = clickablePP . filterOutWsPP [scratchpadWorkspaceTag] $ def
myXmobarPP1 = clickablePP.marshallPP (S 1) $ def
    { ppSep             = "<fc=#586E75> | </fc>" 
    , ppTitleSanitize   = xmobarStrip
    , ppCurrent         = xmobarColor "#ffffff" "#5e8d87" . pad
    , ppHidden          = xmobarColor "#82AAFF" "" . wrap "*" ""
...
main = do
    ...
    --D.requestAccess dbus --polybar method 1
    xmonad $
        dynamicEasySBs barSpawner $ --for polybar method 2 and xmobar, ou should keep this uncommented and for polybar method 2, keep it commented
        withUrgencyHook LibNotifyUrgencyHook $
        --ewmhFullscreen $
        Hacks.javaHack $ -- sets enviroment_JAVA_AWT_WM_NONREPARENTING -- used with XMonad.Util.Hacks
        ewmh $
